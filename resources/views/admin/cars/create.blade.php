              ...
              <div class="card-body">
                <form method="post" action="{{ route('admin.cars.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row border-bottom pb-4">
                      ...
                      <div class="col-sm-10">
                          <select class="form-control" name="type_id" id="type_id" type="text">
                              <option {{ old('type') == 1 ? 'selected' : null }} value="1">Sedan</option>
                              <option {{ old('type') == 2 ? 'selected' : null }} value="2">SUV</option>
                              <option {{ old('type') == 3 ? 'selected' : null }} value="3">Hatchback</option>
                          </select>
                      </div>
                   </div>                  
                    <div class="form-group row border-bottom pb-4">
                      ...
                      <div class="col-sm-10">
                          <select class="form-control" name="transmisi" id="transmisi" type="text">
                              <option {{ old('type') == 1 ? 'selected' : null }} value="Matic">Matic</option>
                              <option {{ old('type') == 2 ? 'selected' : null }} value="Manual">Manual</option>
                          </select>
                      </div>
                   </div>                  
                    <div class="form-group row border-bottom pb-4">
                    ...
                    <div class="form-group row border-bottom pb-4">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control" name="unit" value="{{ old('unit') }}" id="unit">
                        </div>
                    </div>
                    <div class="form-group row border-bottom pb-4">
                        <label for="pintu" class="col-sm-2 col-form-label">Tahun</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="tahun" value="{{ old('tahun') }}" id="pintu">
                        </div>
                    </div>
                    <div class="form-group row border-bottom pb-4">
